...
model = torch.load(open("tmp/singlepath_dqn_fl_2.pth", "rb"))
test_envs = ts.env.DummyVectorEnv([lambda : gym.make("SinglePath-v0", bitrate_list=get_fcc_test_data(), train=False)])
